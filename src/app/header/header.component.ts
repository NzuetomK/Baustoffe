...
export class HeaderComponent implements OnInit, OnDestroy{
  ...
  public constructor(private router: Router, private searchService: SearchService, private quantityService: QuantityService, private cdr: ChangeDetectorRef){
    ...
    this.handwerker = [
      ...
      {logo: "assets/images/logo-png.png", adress:"Winnweiler", product_name:"Dachboden-Dämmplatte- 1200x625 mm", radius:22, adress_2:"Kaiserslautern", product_name2:"xx", product_name3:"Ortgangziegel links Falzziegel Engobe", name:"Daba Dach"},
      {logo: "assets/images/Ferocon Bauunternehmen.jpg", adress:"Kaiserslautern", product_name:"Dachboden-Dämmplatte- 1200x625 mm", radius:0, adress_2:"Kaiserslautern", product_name2:"xx", product_name3:"Ortgangziegel links Falzziegel Engobe", name:"Fero Bau"},
      {logo: "", adress:"Rockenhausen", product_name:"Dachboden-Dämmplatte- 1200x625 mm", radius:31, adress_2:"Kaiserslautern", product_name2:"xx", product_name3:"Ortgangziegel links Falzziegel Engobe", name:"Cal Maler Betrieb"},
