...
export class HeaderComponent implements OnInit, OnDestroy{
  ...
  public constructor(private router: Router, private searchService: SearchService, private quantityService: QuantityService, private cdr: ChangeDetectorRef){
    this.items = [
      ...
      {logo: "assets/images/thxxx.jpg", adress:"Eisenberg", product_name:"Superglass Dachboden- 1200x625 mm", name: "Köbig", radius:33, adress_2:"Kaiserslautern", product_name2:"sgdfggjg", product_name3:"Ortgangziegel links Falzziegel Engobe"},
